<div class="mx-auto max-w-md mt-4 w-11/12 md:flex md:flex-col  md:w-1/2 lg:w-6/12 xl:w-1/2 2xl:w-1/2">
    <x-button negative href="{{ URL::previous() }}">Go Back</x-button>
    <div class="font-sans rounded-md border px-6 py-4 max-w-md mb-4">
        ...
        <div class="flex text-grey">
            ...
            <div class="flex items-center mr-4">
                ...
                <button onclick='$openModal("comment")'>
            ...
            {{-- <div class="flex items-center mr-4"><svg class="mr-2" width="24" height="24"
                        viewBox="0 0 24 24">
                        <path class="fill-current"
    ...
    <ul>
        @foreach ($post->comments as $comment)
            <li class="text-xl font-bold"> {{ $comment->commentor->name }}</li>
            <li>{{ $comment->comment }}</li>
            <center>{{ $comment->created_at->diffForHumans() }}</center>
            <hr />
        @endforeach
    </ul>

    <x-modal name="comment" blur="sm">
